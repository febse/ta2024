...
The course material will be presented using Jupyter notebooks. The recommended way to work with the notebooks is through Google Colab, a cloud service that allows you to run Python code in the browser (and includes a generous free tier). You will need a Google account to use Google Colab. If you don't have one, please register here: <https://accounts.google.com/signup>.
